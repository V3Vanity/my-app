      ...
      {currentStep === 32 && (
        ...
        >
          ...
          <p className="text-paragraph__end">
            Ты раскрыл одну из глав Костромы, но книга города только начинается!
            Вас ждут величественные храмы, увлекательные музеи и места, где
            история оживает. Не останавливайся — позволь Костроме удивить тебя
            снова и снова!
          </p>
