  ...
  const LandingPage = () => {
    ...
    return (
      <div className="landing">
        ...
        {/* Модальное окно с согласием на обработку персональных данных в подвале */}
              ...
              <div className="offer-content">
                ...
                <div className="offer-text">
                  <p>
                    ...
                    Индивидуальному предпринимателю Коробко Юлии Евгеньевне
                    (ИНН: 440120991310) (далее — Оператор) на обработку своих
                  ...
                  <ul>
                    ...
                    <li>
                      Данные геолокации (для работы карты и построения
                      маршрутов)
                    </li>
                  ...
                  <ul>
                    <li>Предоставление доступа к электронному путеводителю</li>
                    <li>Обработка платежей и оформление подписки</li>
                  ...
                  <p>
                    3.3. Оператор имеет право привлекать третьих лиц с
                  ...
                  <ul>
                    ...
                    <li>Получать информацию о сроках и способах обработки</li>
