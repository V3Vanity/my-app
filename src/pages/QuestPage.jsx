...
export default function QuestPage() {
  ...
  // Проверяем localStorage при монтировании страницы
  useEffect(() => {
  ...
  // Обновляем localStorage при изменении шага
  useEffect(() => {
  ...
  const handleStartJourney = () => {
    setJourneyStarted(true);
    setCurrentStep(1); // начинаем с первого шага
  };
  ...
  const step1Text = ` Вступай, путник, в город, где прошлое
